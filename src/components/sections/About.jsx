        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              "Passionate Full-Stack Developer with a strong background in building scalable, high-performance web applications and delivering innovative digital solutions. Skilled in modern technologies, problem-solving, and creating user-friendly experiences that drive impact."
            </p>
